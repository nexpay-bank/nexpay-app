...
extension CardQueryFilter on QueryBuilder<Card, Card, QFilterCondition> {
  ...
  QueryBuilder<Card, Card, QAfterFilterCondition> balanceEqualTo(
    double value, {
  ...
  QueryBuilder<Card, Card, QAfterFilterCondition> balanceGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Card, Card, QAfterFilterCondition> balanceLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Card, Card, QAfterFilterCondition> balanceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CardQuerySortBy on QueryBuilder<Card, Card, QSortBy> {
  ...
  QueryBuilder<Card, Card, QAfterSortBy> sortByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }

  QueryBuilder<Card, Card, QAfterSortBy> sortByBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CardQuerySortThenBy on QueryBuilder<Card, Card, QSortThenBy> {
  ...
  QueryBuilder<Card, Card, QAfterSortBy> thenByBalance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.asc);
    });
  }

  QueryBuilder<Card, Card, QAfterSortBy> thenByBalanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'balance', Sort.desc);
    });
  }
...
extension CardQueryWhereDistinct on QueryBuilder<Card, Card, QDistinct> {
  ...
  QueryBuilder<Card, Card, QDistinct> distinctByBalance() {
    return QueryBuilder.apply(this, (query) {
...
extension CardQueryProperty on QueryBuilder<Card, Card, QQueryProperty> {
  ...
  QueryBuilder<Card, double, QQueryOperations> balanceProperty() {
    return QueryBuilder.apply(this, (query) {
